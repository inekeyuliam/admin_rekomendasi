            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h3 class="card-title ">Daftar Gambar Kamar</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-md " href="{{url('kamar/'.$kamar_id)}}">Kembali</a> &nbsp;&nbsp;&nbsp;
                            <!-- <a class="btn btn-primary btn-md " href="{{url('gambarkamar'.request()->route('id').'/create')}}"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Tambah Gambar</a>  -->
                            <a class="btn btn-primary btn-md " href="{{ route("kamar.gambarkamar.create", $kamar_id) }}"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Tambah Gambar Kamar</a> 
                            ...
                            <div class="table-responsive">
                                ...
                                <thead >
                                        ...
                                        <th class="col-md">Gambar Kamar</th>
									...
									@foreach ($gambar as $key=>$item)
                                        <tr>
											...
											<td>{{$item->filename}}</td>
											<td>
											<a href="{{ route('kamar.gambarkamar.edit', [$item->kamar_id, $item->id]) }}"><i class="fa fa-edit fa-2x"></i></a>
											</td>
                                            <td>
                                            <form action="{{ route('kamar.gambarkamar.destroy', [$item->kamar_id, $item->id] )}}" method="POST">
											{{ method_field("DELETE") }}
