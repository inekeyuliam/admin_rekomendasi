    	...
    	<div class="row">
           <div class="col-md-8">
              	<div class="card">
					...
					<div class="card-body">
						<form class="mt-2" action="{{ route('kamar.gambarkamar.update', [$gambarkamar->kamar_id, $gambarkamar->id]) }}" method="post" enctype="multipart/form-data">{{ method_field("PUT")}}
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<div class="row">
								<div class="col-md-4">
									<label class="exampleFormControlInput1">Pilih Gambar Kamar</label>
             	...
             	<div class="card card-profile">
					...
					<div class="col-md-12">
						<label class="exampleFormControlInput1">Gambar Hotel Awal</label>
									...
									<div class="thumbnail">
										<img class="img-thumbnail mySlides"src="{{ asset('images/'.$gambarkamar->filename) }}" />
									</div>
						</div>
						<br>   
...
$('#filename').on('change', function () {
    handleFileSelect();
    var dots = $('#judul').append('Gambar Kamar Baru');
