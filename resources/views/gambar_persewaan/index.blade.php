                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-md " href="{{url('lihat/persewaan')}}">Kembali</a> &nbsp;&nbsp;&nbsp;
                            <a class="btn btn-primary btn-md " href="{{url('gambarsewa/create')}}"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp;Tambah Gambar</a> 
                            </div>
