          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Input Data Persewaan </h4>
                </div>
              <div class="card-body">
                <form class="mt-2" action='{{url("simpan/bobot/persewaan")}}' method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-header card-header-primary">
                  <h6 class="card-title">Bobot Nilai Kriteria Persewaan</h6>
                </div>
                <div class="card-body">
                <input type="hidden" id="from_places" value="{{$alamat}}">
                <input type="hidden" id="long" value="{{$long}}">
                <input type="hidden" id="lat" value="{{$lat}}">
                <input type="hidden" id="surat" value="{{$rata}}">
                <input type="hidden" id="kapasitas" value="{{$kapasitas}}">
...
function updateCount() {
    ...
    var k = $('#kapasitas').val();
    var s = $('#surat').val();
    $('#nilai_kriteria13').val(x);
    $('#nilai_kriteria14').val(s);
    $('#nilai_kriteria15').val(r);
    $('#nilai_kriteria16').val(m);
    $('#nilai_kriteria17').val(k);
};
