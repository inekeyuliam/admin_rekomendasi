...
<html class="wide wow-animation" lang="en"> 
  ...
  <body>
    ...
    <header class="section page-header">
             ...
             @if($list['rating'] == 4.5 || $list['rating'] > 4.5 )
              ...
              @elseif($list['rating'] == 2.0 || $list['rating'] < 3.0  )
                <p class="heading-5">  
                  ...
                  <span class="fa fa-star"></span>
                  <span class="fa fa-star"></span>
                  {{$list['rating']}} / 5  <a class="pull-right" data-toggle="modal" data-target="#exampleModalCenter" href="#exampleModalCenter"'> <u>Rating & Review Google</u> </a></p>
          ...
          <div class="row row-fix row-50 row-custom-bordered">
            ...
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-comma list-0">
                  @if($list['link_ig'] == '' && $list['link_fb'] == '')
                  <li class="icon mdi mdi-facebook"> - </li>
                  <li class="icon mdi mdi-instagram"> - </li>
                  @elseif($list['link_ig'] == '')
                    <li class="icon mdi mdi-instagram"> - </li>
      ...
      <section class="section section-lg bg-default text-center">
        <div class="container container-wide">
          <h3>Kendaraan Persewaan</h3>
          <div class="divider divider-secondary"></div>
          <div class="row row-50 justify-content-sm-center text-center">
          @foreach($kendaraan as $item)
            <div class="col-sm-10 col-md-6 col-xl-3">
              <article class="box-minimal box-minimal-border">
                <p class="big box-minimal-title">{{$item->nama_model}}</p>
                <hr>
                <div class="box-minimal-text text-spacing-sm">
                <img class="rounded-circle" src="{{asset('images/'.$item->filename_gambar) }}" alt="" width="300" height="300"/>
                <p class="team-classic-job-position">{{$item->jenis_kendaraan}}, {{$item->nama_merk}}</p>
                <p class="team-classic-job-position">Rp{{number_format($item->biaya_perhari,2)}} per hari</p>
                <p class="team-classic-job-position">Keluaran Tahun {{$item->tahun_keluaran}}, Kapasitas {{$item->kapasitas}} org </p>
              </div>
              </article>
            </div>
          @endforeach
            ...
            <article class="quote-boxed">
              ...
              <div class="quote-boxed-main">
                ...
                <div class="quote-boxed-meta">
                  ...
                  @if($item->rate == 4.5 || $item->rate  > 4.5 )
                ...
                <span class="fa fa-star checked"></span>
                {{$item->rate }} / 5</p>
              @elseif($item->rate  == 4.0 || $item->rate  < 4.5  )
              <p class="quote-boxed-small"> 
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star checked"></span>
                  ...
                  <span class="fa fa-star"></span>
                  {{$item->rate }} / 5</p>
              @elseif($item->rate  == 3.0 ||$item->rate < 4.0  )
              <p class="quote-boxed-small"> 
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star checked"></span>
                  ...
                  <span class="fa fa-star"></span>
                  {{$item->rate }} / 5</p> 
              @elseif($list['rating'] == 2.0 || $item->rate < 3.0  )
              <p class="quote-boxed-small">
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star"></span>
                  ...
                  <span class="fa fa-star"></span>
                  {{$item->rate }} / 5</p> 
              @elseif($item->rate  == 1.0 || $item->rate < 2.0  )
              <p class="quote-boxed-small">  
                  <span class="fa fa-star checked"></span>
                  <span class="fa fa-star"></span>
                  <span class="fa fa-star"></span>
