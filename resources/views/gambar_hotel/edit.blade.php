@extends('layouts.app', ['activePage' => 'lihathotel', 'titlePage' => __('Tambah Kamar')])
@section("content")
    <div class="content">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Input Gambar Hotel </h4>
                </div>
                <div class="card-body">
                <form class="mt-2" action='{{url("gambarhotel/".$gambar->id)}}' method="post" enctype="multipart/form-data">{{ method_field("PUT")}}
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body"> 
                    <div class="col-md-12">
                    <label class="exampleFormControlInput1">Gambar Hotel Awal</label>

								<div class="thumbnail">
									<img class="img-thumbnail mySlides"src="{{ asset('images/'.$gambar->filename) }}" />
								</div>
					</div>
					<br>                        
...
$('#filename').on('change', function () {
    handleFileSelect();
    var judul = $('#judul').append('Gambar Hotel Baru');
