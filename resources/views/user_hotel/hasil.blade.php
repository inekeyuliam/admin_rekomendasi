        ...
        <div class="container container-bigger form-request-wrap form-request-wrap-modern">
          <div class="row row-fix justify-content-xl-end row-30 text-center text-xl-left">
                ...
                <div class="col-xl-3 text-xl-right">
                  <a class="button button-secondary button-nina"  data-toggle="modal" data-target="#exampleModal" href="#exampleModal">Bandingkan Hotel</a>
                </div>
                <br><br>
             ...
             @if($item['rating'] == 4.5 || $item['rating'] > 4.5 )
              ...
              @elseif($item['rating'] == 1.0 || $item['rating'] < 2.0  )
                <p class="heading-5">  
                  ...
                  {{$item['rating']}} / 5</p>              
              @endif
              <p class="text-spacing-sm">Alamat : {{$item['alamat']}}</p><a class="button button-secondary-outline button-nina" href="{{url('hotel/'.$item['id'])}}">Lihat Hotel</a>
            </div>
