      ...
      <section class="section section-variant-1 bg-default novi-background bg-cover"> 
        <div class="container container-bigger form-request-wrap form-request-wrap-modern">
          <div class="row row-fix justify-content-xl-end row-30 text-center text-xl-left">
                ...
                <br> <a class="button button-secondary button-nina"  data-toggle="modal" data-target="#exampleModal" href="#exampleModal">Bandingkan Hotel</a>
            ...
            <div class="col-md-10 col-lg-6 col-xl-5">
              ...
              @elseif($item['rating'] == 1.0 || $item['rating'] < 2.0  )
                <p class="heading-5">  Rating :  
                  ...
                  {{$item['rating']}} / 5</p>              
              @endif
              <p class="text-spacing-sm" style="font-size:21px;font-family:serif">Alamat : {{$item['alamat']}}</p><a class="button button-secondary-outline button-nina" href="{{url('detailhotel/'.$item['id'])}}">Lihat Hotel</a>
            </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Pilih Hotel (Maksimal 3)</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form method="POST" action="/showHotel">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="modal-body">
                <div class="form-check">
                @foreach($ranking as $item)
                <label><input type="checkbox" id="hotel" name="hotel[]" value="{{$item['id']}}">
                {{$item['nama']}}</label><br>
                @endforeach
                @foreach($kritwis as $krit)
