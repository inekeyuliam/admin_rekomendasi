        ...
        <section class="section section-variant-1 bg-default novi-background bg-cover"> 
            ...
            <div class="row row-fix justify-content-xl-end row-30 text-center text-xl-left">
                ...
                <div class="parallax-text-wrap">
                    <h3> Daftar Hotel di Jawa Timur</h3>
                </div>
                <hr class="divider divider-secondary">
                </div>
                <div class="col-xl-3 text-xl-right"><a class="button button-secondary button-nina"  data-toggle="modal" data-target="#exampleModal" href="#exampleModal">Filter Hotel</a></div>
            </div>
