  ...
  <body>
    ...
    <header class="section page-header">
            ...
            <div class="col-md-10 col-lg-6 col-xl-5">
             ...
             @if($list['rating'] == 4.5 || $list['rating'] > 4.5 )
              ...
              @foreach($gambar as $key => $item2)
                @if($key == 1)
                  <img class="mySlides" src="{{ asset('images/'.$item2->filename) }}" style="width:570;height:370;cursor:pointer;alt=''"/>
                @else
     ...
     <!-- Modal -->
      ...
      <!-- <a class="button button-secondary button-nina" data-toggle="modal" data-target="#exampleModal2">Rating & Review dari Google</a> -->
