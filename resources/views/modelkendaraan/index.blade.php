                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 ">
                            <a class="btn btn-primary btn-md pull-right" href="{{url('modelkendaraan/create')}}">Tambah Model</a> 
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <thead >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{url('modelkendaraan/'.$item->id.'/edit')}}"><i class="fa fa-edit fa-2x"></i></a>
                                        </td>                         
                                        <td>
