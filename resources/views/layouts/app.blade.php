...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Administrator Sistem Rekomendasi Wisata') }}</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/') }}/assets/css/dataTables.bootstrap.min.css"/>
    <!-- <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css
"/> -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <script  defer src="https://maps.googleapis.com/maps/api/js?libraries=places&language=en&key=AIzaSyCkYnXZ4w1JidfCF9nspLGP5VqNGJ8EgOc"  type="text/javascript"></script>
    ...
    <script src="https://cdn.datatables.net/1.10.24/css/dataTables.material.min.css"></script>
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <!--  Google Maps Plugin    -->
        <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-Bf2b8GnxaTOxWtGclr_pCrtdW9Btx3A"></script> -->
        <!-- Chartist JS -->
