        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <h4 class="card-title">Data Bobot Kriteria Hotel</h4>
                    </div>
                    <div class="card-body">
                        <form class="mt-2">
                        ...
                        <div class="form-group">
                            <a href="{{url('keubahbobot/hotel')}}" class ="btn btn-primary"><i class="fa fa-refresh" aria-hidden="true"></i> &nbsp; perbarui nilai Bobot</a>
                        </div>
                    </div>
                </div>
