        ...
        <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="mt-2" action='{{url("ubah/hotel/".$list->id)}}' method="post" enctype="multipart/form-data">
					        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div class="row">
                                <div class="col-xl-3 col-lg-7">
                                    <div class="form-group">
                                        <label class="exampleFormControlInput1">Nama Hotel</label>
                                        <input class="form-control" type="text" name="nama" value="{{$list->nama_hotel}}"  >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-2 col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="bintang" value="{{$list->bintang}}"  >
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-md-6 mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label style="font-size:15px;">Tambah Gambar Hotel</label>&nbsp;<br><br>
...
$('#filename').on('change', function () {
    handleFileSelect();
    var dots = $('#judul').append('Tambah Gambar Hotel');
