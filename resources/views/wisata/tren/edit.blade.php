@extends('layouts.app', ['activePage' => 'wisata', 'titlePage' => __('Tambah Kamar')])
@section("content")
    <div class="content">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Input Gambar Wisata </h4>
                </div>
                <div class="card-body">
                <form class="mt-2" action='{{url("tren/wisata/".$wis->id)}}' method="post" enctype="multipart/form-data">{{ method_field("PUT")}}
					<input type="hidden" name="_token" value="{{ csrf_token() }}">  
					<div class="row">
                    <div class="col-md-4">
                        <label class="exampleFormControlInput1">Nama  Wisata</label>
                        <input type="text" class="form-control" value="{{$wis->nama_top_wisata}}" readonly/>
                    </div>
                    </div><br>               
                    <div class="row">
                    <div class="col-md-4">
