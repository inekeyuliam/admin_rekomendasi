...
class GoogleMaps{
    ...
    */
    public static function geocodeAddress( $address, $kel, $kec, $kab ){
         /*
    Builds the URL and request to the Google Maps API
    */
    // $url = 'https://maps.googleapis.com/maps/api/geocode/json?address='.urlencode( $address.', '.$kel.', '.$kec.', '.$kab ).'&key='.env( 'AIzaSyDlonq77RRXstOW6tg_rw5i2EiBYpAnMhI' );
